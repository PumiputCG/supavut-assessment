...
return new class extends Migration
{
    ...
    {
        Schema::create('export_employees', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('assessment_status', 20)->nullable()->index();
            ...
            $table->decimal('supervisor_score_leadership', 10, 2)->nullable();
            $table->decimal('supervisor_score_attitude', 10, 2)->nullable();
            ...
            $table->unique(['cycle_id', 'employee_code'], 'uq_export_employees_cycle_employee');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('export_employees');
    }
};
